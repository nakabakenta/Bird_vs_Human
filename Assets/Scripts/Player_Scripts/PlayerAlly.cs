...
public class PlayerAlly : PlayerBase
{
    //処理
    ...
    void Start()
    {
        GetComponent();
        direction.y = 90.0f;
        allyObject = Instantiate(player[GameManager.selectPlayer], new Vector3(this.transform.position.x, this.transform.position.y - 0.5f, this.transform.position.z), this.transform.rotation, thisTransform);
